 ...
 */
Object.keys(xss.whiteList).forEach(function(k){
...
ClauseSchema.methods.update = function update(data) {
  ...
  this.text = xss(data.text || this.text);
};
...
LawSchema.index({ state: 1, lawId: 1 }, { unique: false, dropDups: false });
