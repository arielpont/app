...
exports.emails = function(val, option, fn) {
  val = val.trim();
...
exports.firstname = function(val, option, fn) {
  val = val;
  fn(!regexps.names.test(val) && '' != val.trim() ? t('validators.invalid.firstname') : null);
};

exports.lastname = function(val, option, fn) {
  val = val.trim();
  fn(!regexps.numeric.test(val) && '' != val ? t('validators.invalid.lastname') : null);
};
